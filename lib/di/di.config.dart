...
import '../repository/news/dataSource/news_remote_data_source_impl.dart' as _i5;
import '../repository/news/news_data_source.dart' as _i4;
...
import '../repository/sources/source_data_source.dart' as _i9;
import '../repository/sources/source_repository_contract.dart' as _i12;
  ...
  _i1.GetIt init({
    ...
    gh.factory<_i14.CategoryDetailsViewModel>(() =>
        _i14.CategoryDetailsViewModel(
            repositoryContract: gh<_i12.SourceRepositoryContract>()));
    return this;
  }
}
